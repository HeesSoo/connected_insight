        ...
        <div className="w-full">
            ...
            <div className="w-full max-w-[1440px] mx-auto flex mx-auto pt-[80px] pb-[160px] gap-[137px]">
                <div className="w-[712px]">
                    <Image src={case1.src} alt="Reservation Lab" width={712} height={398} className="h-[auto] w-[100%]" />
                </div>
                <div>
                    <h3 className="text-h3 font-semibold mb-6">Reservation Lab</h3>
                    <div className="max-w-[591px] text-large">
