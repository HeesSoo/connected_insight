                    ...
                    pagination={{
                        ...
                        renderBullet: (index, className) => {
                            ...
                            if (index < banners.length) {
                                return `<span class="${className} font-semibold text-large text-white bg-g200 px-5 py-2 select-none">${banners[index].name}</span>`;
                            }
                            return `<span class="${className} font-semibold text-large text-white bg-g200 px-5 py-2 select-none">Product Finder</span>`;
                        },
                    }}
                    className="mySwiper"
                >
