        ...
        <div className="max-w-full">
            ...
            {banners && banners.length > 0 && (
                <div className="relative">
                        ...
                        pagination={{
                            ...
                            renderBullet: (index, className) => {
                                ...
                                if (index < banners.length) {
                                    return `<span class="${className} font-semibold text-large text-white bg-g200 px-5 py-2 select-none max-sm:hidden">${banners[index].name}</span>`;
                                }
                                return `<span class="${className} font-semibold text-large text-white bg-g200 px-5 py-2 select-none max-sm:hidden">Product Finder</span>`;
                            },
                        }}
                        className="mySwiper"
                    >
                        {banners.map((item, index) => (
                            <SwiperSlide key={index}>
                                <Image
                                    ...
                                    width={1920}
                                    height={640}
                                    className="w-full h-auto object-cover max-sm:h-[300px]"
                                />
                            </SwiperSlide>
                        ))}
                        ...
                        <SwiperSlide key="custom-banner" className="relative">
                            <Image
                                ...
                                className="w-full h-auto object-cover max-sm:h-[300px]"
                            />
                            <div className="w-full h-full absolute top-0 left-0 z-20 pr-[80px] flex justify-end items-center max-sm:pr-0 max-sm:justify-center">
                                <div className="text-white max-sm:text-center">
                                    <div className="mb-2 text-[32px] leading-[48px] tracking-[-0.2px] font-bold max-sm:text-xl">
                                        Find the Perfect
                                        <br />
                                        TOKK Solution
                                    </div>
                                    <div className="mb-12 text-2xl leading-9 tracking-[-0.2px] font-medium max-sm:text-base max-sm:mb-6">
                                    ...
                                    >
                                        <Button
                                            ...
                                            onClick={() => {}}
                                            size="large"
                                            className="text-titleSmall max-sm:text-base"
                                        />
                                    </a>
                                </div>
                            </div>
                    ...
                    {totalSlides > 1 && (
                        <div className="hidden justify-center items-center gap-3 mt-3 max-sm:flex">
