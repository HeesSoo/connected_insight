...
const menuItems: MenuItem[] = [
    ...
    // },
    {
        ...
        children: [
            ...
            { id: "product-create", label: "제품 생성", href: "/admin/products/create" },
        ],
    },
    {
        id: "contact",
...
export default function AdminLNB() {
    ...
    const [openMenus, setOpenMenus] = useState<string[]>(["products", "contact"]);
                    ...
                    <div>
                        <button
                            ...
                            className={`w-full flex items-center justify-between px-4 py-3 text-base font-medium rounded-[2px] transition-colors ${
                                active ? "bg-ePrimary text-white" : "text-g700 hover:bg-g50"
                            }`}
                        >
    ...
    return (
        <aside className="w-[260px] bg-white border-r border-g200 h-[calc(100vh-72px)] sticky top-[72px] overflow-y-auto">
            <nav className="p-4">
                <div className="mb-6">
                    <h2 className="text-small font-semibold text-g400 uppercase tracking-wider px-4 mb-2">메뉴</h2>
                </div>
