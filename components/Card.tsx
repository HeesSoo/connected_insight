    ...
    return (
        <div>
            <div className="w-full">
                {/* 이미지 영역 */}
                <div className={`relative mb-5 max-md:mb-6`}>
                    <Image
                    ...
                    <div className="absolute bottom-6 left-6">
                        <div className="text-g200 text-base mb-1 max-md:text-sm">
                            Case 0{item.index + 1}
                        </div>
                        <h3
                            className={`font-[600] text-white text-titleSmall max-md:text-base`}
                        >
                            {item.name}
                        </h3>
                    </div>
                ...
                {/* 콘텐츠 영역 */}
                {currentLanguage === "ko" && (
                    <div className="flex flex-col h-[170px] justify-between max-md:h-fit max-md:justify-start max-md:gap-6">
                        {item.core_inspector_target_ko && (
                            <div>
                                <div className="text-ePrimary text-base mb-1 font-[500] max-md:text-sm">
