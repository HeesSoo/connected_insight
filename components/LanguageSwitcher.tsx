...
export default function LanguageSwitcher({
    ...
    const language = isFirstRender ? initialLang : currentLanguage;
    ...
    useEffect(() => {
        ...
        isFirstRender = false;
    }, [initialLang, currentLanguage, setLanguage]);
    ...
    return (
        <div className="w-fit flex items-center">
            ...
            <button
                ...
                } text-white px-3 text-small leading-5 rounded-xl transition-colors select-none max-md:w-[42px] max-md:h-[24px]`}
