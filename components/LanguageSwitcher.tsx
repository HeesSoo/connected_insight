...
export default function LanguageSwitcher({ initialLang }: LanguageSwitcherProps) {
    ...
    return (
        <div className="w-fit flex items-center">
            ...
            <button
                className={`mr-1 h-6 ${language === "ko" ? "bg-g950" : "bg-g200"} text-white px-3 text-small leading-5 rounded-xl`}
                onClick={() => handleLanguageChange("ko")}
            >
                KR
            </button>
            <button
                className={`mr-1 h-6 ${language === "en" ? "bg-g950" : "bg-g200"} text-white px-3 text-small leading-5 rounded-xl`}
